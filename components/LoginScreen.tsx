...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, onNavigateToSignUp, error }) => {
      ...
      <div className="flex-grow flex flex-col justify-center items-center px-4">
        <div className="max-w-md w-full mx-auto">
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            ...
            <button onClick={onNavigateToSignUp} className="font-medium text-purple-600 hover:text-purple-500 focus:outline-none focus:underline">
              Sign Up
            </button>
          </p>
        </div>
